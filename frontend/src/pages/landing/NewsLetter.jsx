...
function NewsLetter() {
  ...
  return (
    <div className=" bg-white text-white px-4  max-w-[1440px]  mx-auto p-8 md:p-16 lg:p-[82px]">
      <div className="flex flex-col flex-start bg-black px-5 xs:px-6 sm:px-8 md:px-10 py-8 sm:py-10 md:py-12 lg:py-16 mx-auto rounded-lg shadow-lg">
