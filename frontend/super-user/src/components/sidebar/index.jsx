...
import { FaBuilding, FaBars, FaUsers, FaChevronLeft } from "react-icons/fa";
      ...
      >
        <div
          className={`relative h-full transition-all duration-300 ${
            isSidebarOpen
              ? "w-72 p-4 bg-indigo-900  dark:bg-darkCard text-white"
              : "w-16 px-3 bg-indigo-900  dark:bg-darkCard py-4"
          }`}
        >
          ...
          {isMobile && (
            <button
              ...
              className="absolute top-4 -right-10 p-2 bg-indigo-900 text-white rounded-r-lg hover:bg-indigo-800 transition-colors z-[70]"
            >
              <FaBars size={24} />
            </button>
          )}
          ...
          <div className="w-full">
            ...
            <div className="flex  w-full h-12 items-center justify-between  transition-all duration-200">
              {isSidebarOpen && (
                <div className="w-full mx-auto flex justify-center font-mono font-bold text-3xl">
                  ProjectX
                </div>
              )}
              {!isMobile && (
                ...
                >
                  {isSidebarOpen ? (
                    ...
                    <img className="sm:ml-2 h-10 " src={logo} />
                  )}
                </button>
              )}
            </div>
