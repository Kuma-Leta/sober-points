...
const ForgotPassword = () => {
  ...
  return (
    <div className="w-full flex flex-col h-screen justify-center items-center m-auto">
      <ToastContainer />
      <div className="p-14 w-full md:w-auto md:min-w-[400px] mb-10 dark:border-gray-600 border bg-gray-200 dark:bg-darkCard">
        ...
        <form className="w-full pb-5" onSubmit={handleSubmit}>
          <div className="mb-4 w-full">
            <input
              ...
              className="w-full dark:bg-darkBg  border-b-2 border-primary p-3 focus:outline-none"
              required
            />
          </div>
          {!showResend && (
